...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/car1.jpg" class="d-block w-100" alt="..." height="500px" width="200px">
    ...
    <div class="carousel-item">
      <img src="img/car2.jpg" class="d-block w-100" alt="..." height="500px">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="img/car3.jpg" class="d-block w-100" alt="..." height="500px">
      <div class="carousel-caption d-none d-md-block">
...
<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" style="height: 18.5rem;margin: 3rem 0rem 0rem 4rem;width: 16rem;" src="img/doct.jpg">
			</div>
	...
	<div class="container p-2" style="margin-bottom:2.5rem">
